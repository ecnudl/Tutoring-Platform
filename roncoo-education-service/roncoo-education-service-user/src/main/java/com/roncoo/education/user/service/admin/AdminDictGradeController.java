...
import com.roncoo.education.user.service.admin.biz.AdminDictGradeBiz;
...
@RequestMapping("/user/admin/dict-grade")
public class AdminDictGradeController {
    @NotNull
    private final AdminDictGradeBiz biz;
