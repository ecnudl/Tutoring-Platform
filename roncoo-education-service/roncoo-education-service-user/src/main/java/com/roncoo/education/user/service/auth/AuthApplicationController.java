...
public class AuthApplicationController {
    ...
    @ApiOperation(value = "入围") @PutMapping("/shortlist")
    public Result<String> shortlist(@RequestParam Long id) { return biz.shortlist(id); }
    @ApiOperation(value = "录用") @PutMapping("/accept")
    public Result<String> accept(@RequestParam Long id) { return biz.accept(id); }
    @ApiOperation(value = "拒绝") @PutMapping("/reject")
