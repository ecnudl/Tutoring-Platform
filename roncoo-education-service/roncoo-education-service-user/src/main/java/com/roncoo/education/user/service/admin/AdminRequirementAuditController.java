...
import com.roncoo.education.user.service.admin.biz.AdminRequirementAuditBiz;
...
@RequestMapping("/user/admin/requirement-audit")
public class AdminRequirementAuditController {
    @NotNull
    private final AdminRequirementAuditBiz biz;
