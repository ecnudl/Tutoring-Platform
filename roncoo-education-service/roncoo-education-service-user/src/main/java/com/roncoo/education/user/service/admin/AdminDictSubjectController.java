...
import com.roncoo.education.user.service.admin.biz.AdminDictSubjectBiz;
...
@RequestMapping("/user/admin/dict-subject")
public class AdminDictSubjectController {
    @NotNull
    private final AdminDictSubjectBiz biz;
