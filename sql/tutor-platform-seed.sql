...
(800103, NOW(), NOW(), 1, 800000, '需求列表',   '/requirement/list',    '', 1, 4, '/user/admin/requirement/page,/user/admin/requirement/view,/user/admin/requirement/save,/user/admin/requirement/edit,/user/admin/requirement/delete,/user/admin/requirement/confirm-match'),
