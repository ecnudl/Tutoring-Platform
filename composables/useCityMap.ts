...
export const CITY_LIST: CityEntry[] = [
  ...
  { id: 10, name: '北京', pinyin: 'beijing',   enabled: true },
  ...
  { id: 12, name: '天津', pinyin: 'tianjin',   enabled: true },
  { id: 13, name: '武汉', pinyin: 'wuhan',     enabled: true },
  { id: 14, name: '郑州', pinyin: 'zhengzhou', enabled: true },
  { id: 15, name: '重庆', pinyin: 'chongqing', enabled: true },
  { id: 16, name: '西安', pinyin: 'xian',      enabled: true },
  { id: 17, name: '成都', pinyin: 'chengdu',   enabled: true },
  { id: 18, name: '长沙', pinyin: 'changsha',  enabled: true },
]
