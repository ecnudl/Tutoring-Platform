...
export const HELP_ARTICLES: Record<string, HelpArticle> = {
    ...
    sections: [
      {
        title: '关于平台',
        qa: [
          { q: '591家教网如何收费？', a: '平台对家长完全免费——不收会员费、不收中介费。课时费由家长直接支付给教员。' },
  ...
  'payment-method': {
    ...
    category: 'common',
    lead: '591家教网 <strong>全程不收取任何中介费</strong>。以下是家长和教员之间的课时费结算方式说明。',
    sections: [
      {
        title: '支付方式',
        list: [
