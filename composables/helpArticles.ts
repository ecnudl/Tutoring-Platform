    ...
    sections: [
      ...
      },
      {
        ...
        qa: [
          ...
          { q: '课时费如何支付？', a: '首次课时费会随中介费一并通过教员上缴客服 (即首单课时费等同教员侧中介费); 之后所有续单课时费由家长直接支付给教员，不经平台。建议按课时或按周结算，避免纠纷。' },
    ...
    sections: [
      {
        title: '关于平台',
        qa: [
          { q: '591家教网如何收费？', a: '家长：试讲匹配后一次性收 100 元中介费；对教员不满意，可联系客服免费推荐其他教员直到满意为止（家长侧不再额外付中介费）。教员：上岗后中介费 = 首次课时费金额（如 2 小时 350 元 → 中介费 350 元，首单收益归平台）；只上 1 次课减半退还，2 次及以上不退。<strong>续单课时费由家长直接支付给教员，平台不再收取。</strong>' },
