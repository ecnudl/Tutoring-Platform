<template>
  ...
  <div class="container req-detail-page">
    ...
    <!-- 申请弹窗 -->
    <el-dialog v-model="applyVisible" title="申请这个需求" width="500px" :fullscreen="isMobile">
...
@media (max-width: 768px) {
  ...
  .req-detail-page :deep(.el-descriptions--border .el-descriptions__body .el-descriptions__cell) { padding: 8px; }
}
</style>
