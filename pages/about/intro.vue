...
<div class="container about-wrapper">
  ...
  <article class="about-card">
    ...
    <div v-else class="about-body">
      ...
      <p class="about-lead">
        {{ siteBrand }} 是一家专注于<strong>一对一家教信息撮合</strong>的互联网服务平台，致力于为家长/学员和优质教员提供高效、可信、零中介的对接服务。
      </p>
      ...
      <ul>
        ...
        <li>支持电话、微信直接沟通，无需通过中介二次传话</li>
      </ul>

      <h2>我们的承诺</h2>
      <ul>
        <li><strong>不收取中介费</strong>：平台只做信息撮合，不抽成教员课时费</li>
