<template>
  <div>
    <section class="banner">
      <h1 class="banner-title">家教在线平台</h1>
      <p class="banner-desc">找家教、做家教，一站式服务平台</p>
...
<style scoped>
.banner { background: linear-gradient(135deg, #409eff, #67c23a); color: #fff; padding: 80px 20px; text-align: center; }
.banner-title { font-size: 42px; margin-bottom: 16px; }
.banner-desc { font-size: 18px; margin-bottom: 24px; }
.home-content { padding: 40px 20px; }
.steps-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 40px; }
@media (max-width: 768px) {
  .banner { padding: 50px 16px; }
