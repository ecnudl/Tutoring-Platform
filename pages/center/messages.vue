...
const tabs = computed(() => [
  { key: 'system', label: '系统消息', badge: systemMessages.value.length ? systemMessages.value.length : 0 },
  { key: 'notice', label: '网站公告', badge: notices.value.length ? notices.value.length : 0 }
])
