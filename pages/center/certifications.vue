...
<div>
  ...
  <el-card style="margin-bottom:20px">
    ...
    <el-form :model="certForm" label-width="80px" class="cert-form">
      <el-form-item label="类型">
        <el-select v-model="certForm.certType" placeholder="证书类型" class="cert-select">
      ...
      <el-form-item label="名称">
        <el-input v-model="certForm.certName" placeholder="证书名称" class="cert-input" />
      </el-form-item>
      <el-form-item label="编号">
        <el-input v-model="certForm.certNo" placeholder="证书编号(选填)" class="cert-input" />
      </el-form-item>
      <el-form-item>
...
<style scoped>
.cert-form { display: flex; flex-wrap: wrap; gap: 12px; align-items: flex-end; }
.cert-select { width: 140px; }
.cert-input { width: 160px; }
@media (max-width: 768px) {
  .cert-form { flex-direction: column; align-items: stretch; }
  .cert-form :deep(.el-form-item) { display: block; margin-right: 0; margin-bottom: 12px; }
  .cert-select, .cert-input { width: 100%; }
