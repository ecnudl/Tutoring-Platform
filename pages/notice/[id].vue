...
const noticeMap = {
  ...
  'brokerage-policy': {
    ...
    content: `
      ...
      <h3>具体流程</h3>
      <ol>
        <li>客服联系教员，告知付费方式与待匹配学员信息</li>
        <li>家长 100 元中介费由教员代收, 撮合后随首单一并上缴客服</li>
        <li>双方中介费缴齐后，客服向教员提供家长电话</li>
        <li>教员联系家长，明确上课时间与地点</li>
      </ol>
      <h3>提醒</h3>
      <ul>
        <li>请通过客服正常缴纳中介费，<strong>切勿绕过平台直接联系家长</strong>，否则平台将对教员账号做降权处理</li>
      </ul>
    `
  },
